...
def tree_to_code(tree, feature_names, input_program):
    ...
    while True:
        ...
        if conf:
            ...
            print("Entered symptom:", disease_input)
            print("Pattern matched:", conf)
            print("Matched diseases:", cnf_dis)
...
def main():
    ...
    program = ListInputProgram(user_responses)

    getSeverityDict()
    getDescription()
    getprecautionDict()
    result = getInfo(program) + "\n" + tree_to_code(clf, cols, program)
    return result
